...
mlc_llm compile --device cuda --opt O3 \
    --output /data/models/mlc_llm/model_lib/qwen2.5-coder-7b-instruct_aarch64-cu126-sm87_8192-context-window.so \
    --overrides="tensor_parallel_shards=1;context_window_size=8192;prefill_chunk_size=4096" \
    /data/models/mlc_llm/Qwen/Qwen2.5-Coder-7B-Instruct-q4f16_ft-MLC/mlc-chat-config.json