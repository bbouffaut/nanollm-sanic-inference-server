...
python3 /workspace/mlc-llm/python/mlc_llm/__main__.py  compile --device cuda --opt O3 \
    --output /data/models/mlc_llm/model_lib/gemma-2-2b-it-q4f16_1-mlc_aarch64-cu126-sm87.so \
    --overrides="tensor_parallel_shards=1;context_window_size=8192;prefill_chunk_size=8192" \
